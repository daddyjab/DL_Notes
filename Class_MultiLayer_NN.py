...
def relu(a_vector):
    ...
    Static method to calculate the sigmoid activation function
    """
    return max(0, a_vector)

def leaky_relu(a_vector):
    """
    Static method to calculate the sigmoid activation function
    """
    return max(0.01*a_vector, a_vector)
...
class MultiLayer_NN():
    ...
    Primary Methods
    * __init__ (Constructor: Initializes the Neural Network (NN)
    * __repr__(Representation): Official representation of the object
    * __str__ (String)): User friendly representation of the object
    * configure: Establishes the configuration of the NN
    ...
    * predict: Predicts output labels based upon specified input feature data
    ...
    def __init__(self):
        """
        Constructor for the MultiLayer_NN class
        """
